    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <input type="text" id="news_title_input" name="news_title_input" placeholder="Pealkiri"
                value='<?php echo $headline_memory; ?>'>
            <br>
            <label for="news_content_input">Uudise tekst</label>
            <br>
            <!--kuvame echoga muutuja kui näiteks uudise pealkiri ununeb-->
            <textarea id="news_content_input" name="news_content_input" placeholder="Uudise tekst" rows="6"
                cols="40"><?php echo $content_memory; ?></textarea>
            <br>
